...
const DEMO_USER: User = {
  ...
  firstName: 'Demo',
  lastName: 'User',
  publicDisplayName: 'Orbital Voyager 42',
...
const DEMO_USER_2: User = {
  ...
  firstName: 'Sarah',
  lastName: 'Moon',
  publicDisplayName: 'Lunar Moth 817',
...
const DEMO_USER_3: User = {
  ...
  firstName: 'Alex',
  lastName: 'Star',
  publicDisplayName: 'Radiant Glimmer 309',
...
const DEMO_POSTS: Array<Omit<Post, 'lastEditedAt'>> = [
  ...
  },
  {
    ...
    reactions: [{ emoji: '', userId: '', timestamp: null }],
    conversationEnrollees: ['demo-user-2'],
    markedForDeletionAt: null,
    status: 'ready',
    tier: 'big-news',
